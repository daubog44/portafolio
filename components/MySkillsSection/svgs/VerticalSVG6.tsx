...
const VerticalBarSVG6: FC<{ index: string }> = function ({ index }) {
    let value = Number(CardData[5].percentuale.split("%").at(-2));
    value = -((value / 100) * 380) * 1.12;
    let valueCalc = value.toFixed(0);
    console.log(valueCalc, typeof valueCalc);
...
export default VerticalBarSVG6;